...
const symptomsDB = [
  ...
  },
  {
    ...
    symptoms: [
      ...
      "Drooping_wings",
      "Paralysis",
      "Swelling_of_the_tissues_around_the_eyes_and_the_neck",
      "suddenly_death",
      "Reduction_in_production",
    ],
  },
  {
    name: "Infectious Coryza",
    symptoms: [
      "Swollen_head_or_face",
      "Sneezing",
      "Cough",
      "Eye_secretions",
      "Nasal_discharge",
  ...
  },
  {
    name: "Brucellosis",
    symptoms: [
      "Swelling_of_the_testicles_in_males and occasionally the bacteria localizes in the joints causing arthritis",
      "Fever",
      "Shudder",
      "Anorexia",
      "Sweating",
      "Lethargy",
      "Muscle_pain in the joints",
      "muscles and, back, Headache.",
    ],
  },
  {
  ...
  },
  {
    ...
    symptoms: [
      "Frequent_urination",
      "Breaking_housetraining",
      "Blood_in_the_urine",
      "Dribbling_urine",
      "Crying_out_while_urinating",
    ],
  },
];
